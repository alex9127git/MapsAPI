...
def map_screen(screen):
    global input_text1, input_text2, input_text3
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                terminate()
            if event.type == pygame.K_PAGEUP and input_text3:
                if 0 <= int(input_text3) + 1 <= 17:
                    input_text3 = str(int(input_text3) + 1)

            if event.type == pygame.K_PAGEDOWN and input_text3:
                if 0 <= int(input_text3) - 1 <= 17:
                    input_text3 = str(int(input_text3) - 1)
